...
public final class VirtualCore {
     ...
     * 当前插件应用为微信应用时，加载通过andhook框架hook微信中的api的jar包
     */
    private DexClassLoader extendDexClassLoader;

    public DexClassLoader getExtendDexClassLoader() {
        return extendDexClassLoader;
    }

    public void setExtendDexClassLoader(DexClassLoader extendDexClassLoader) {
        this.extendDexClassLoader = extendDexClassLoader;
    }
